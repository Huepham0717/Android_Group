...
public class F0HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        f0AppointmentFrag = new F0AppointmentFrag();
        f0MapFrag = new F0MapFrag();
        switchToAppointmentFrag(findViewById(R.id.f0_home_navbar_home_btn));
    }
...
//        ft.commit();
    ...
    public void switchToAppointmentFrag(View view) {
        ...
        FragmentTransaction ft = getSupportFragmentManager().beginTransaction();
        ft.setCustomAnimations(R.anim.fade_in, R.anim.fade_out);
        ft.replace(R.id.f0_home_frag_container, f0AppointmentFrag);
        ft.commit();
    }
